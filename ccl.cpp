...
#define UINT16 1
#define INT32  2
int labeling_BBDT(const uint8_t* pimg, int w, int h, int stride, void* pimgLabels, int type)
{
	switch (type)
	{
	case UINT16:
		return LabelingGrana(pimg, w, h, stride, (unsigned short *)pimgLabels);
	case INT32:
		return LabelingGrana(pimg, w, h, stride, (int*)pimgLabels);
	default:
		return -1;
	}
}